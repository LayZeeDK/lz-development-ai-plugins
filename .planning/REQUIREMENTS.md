...
- [x] **RECOVERY-04**: `CLAUDE_AUTOCOMPACT_PCT_OVERRIDE=50` recommended in critic agent definitions
...
|-------------|-------|--------|
| ENSEMBLE-01..10 | Phase 7 + Phase 10 | Complete |
| BARRIER-01..04 | Phase 7 + Phase 10 | Complete |
| SPEC-01..05 | Phase 8 | Complete |
| PLAYWRIGHT-01..06 | Phase 8 + Phase 10 | Complete |
| TOKEN-01..05 | Phase 8 | Complete |
| RECOVERY-01..04 | Phase 9 + Phase 10 | Complete |
...
*Last updated: 2026-04-02 after v1.1 milestone completion (all 34 requirements verified)*
