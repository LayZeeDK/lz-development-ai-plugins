...
**Before writing the Visual Design Language section**, read the design principles reference at `${CLAUDE_PLUGIN_ROOT}/lib/frontend-design-principles.md`. Use it to inform your aesthetic direction, typography choices, color philosophy, and spatial composition. The goal is a design language that feels intentionally designed, not assembled from framework defaults.
