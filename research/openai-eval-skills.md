...
image: https://developers.openai.com/images/blog/eval-skills.png
---
...
* [ Latest: GPT-5.4 ](/api/docs/guides/latest-model)
...
* Build agents  
   * [ Agent Builder ](/api/docs/guides/agent-builder)  
   * [ Node reference ](/api/docs/guides/node-reference)  
   * [ Safety in building agents ](/api/docs/guides/agent-builder-safety)  
   * [ Agents SDK ](/api/docs/guides/agents-sdk)
* Deploy in your product  
   * [ ChatKit ](/api/docs/guides/chatkit)  
   * [ Custom theming ](/api/docs/guides/chatkit-themes)  
   * [ Widgets ](/api/docs/guides/chatkit-widgets)  
   * [ Actions ](/api/docs/guides/chatkit-actions)  
   * [ Advanced integration ](/api/docs/guides/custom-chatkit)
* Optimize  
   * [ Agent evals ](/api/docs/guides/agent-evals)  
   * [ Trace grading ](/api/docs/guides/trace-grading)
...
* Cookbooks  
   * [ Codex Prompting Guide ](/cookbook/examples/gpt-5/codex%5Fprompting%5Fguide)  
   * [ Modernizing your Codebase with Codex ](/cookbook/examples/codex/code%5Fmodernization)  
...
* [ Using skills to accelerate OSS maintenance ](/blog/skills-agents-sdk)
* [ Building frontend UIs with Codex and Figma ](/blog/building-frontend-uis-with-codex-and-figma)
* [ Run long horizon tasks with Codex ](/blog/run-long-horizon-tasks-with-codex)
